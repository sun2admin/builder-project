...
7. **L4 template → standalone-repo sync (added 2026-05-07).** `layer4-devcontainer/` (in-repo template) must propagate to standalone Layer 4 repos (e.g. `build-stack-with-claude`). Mapping:
